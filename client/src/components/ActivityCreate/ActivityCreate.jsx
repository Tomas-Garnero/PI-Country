...
export default function ActivityCreate() {
    ...
    function handleSubmit(e) {
        ...
        if(Object.values(errorSaver).length === 0) {
            ...
            Swal.fire({
                title: "Creada",
                text: "La actividad ha sido creada con exito!",
                icon: "success",
    ...
    return (
        <div className="create-bg">
            ...
            <form className="form-container" onSubmit={(e) => handleSubmit(e)}>
                <h1 className="form-title">Crea tu Actividad Turística</h1>
                <div>
                ...
                {(Object.values(errors).length !== 0) &&
                    <p className="p-errors">
                        Completa los campos correctamente para crear tu Actividad
                    </p> 
                }
            </form>
        </div>
